...
def main():
    ...
    t.test('dv_router', 'tests.test_backup')
    t.test('dv_router', 'tests.test_count_to_inf')
    ...
    t.test('dv_router', 'tests.test_count_to_inf_v2')
    t.test('dv_router', 'tests.test_forget_path_2')
    t.test('dv_router', 'tests.test_simple_split_horizon')
    t.test('learning_switch', 'tests.test_learning_removal')
    t.test('dv_router', 'tests.test_recover_from_count_to_inf', extra_args=['--poison-mode'])
    t.test('dv_router', 'tests.test_poisoning', extra_args=['--poison-mode'])
    t.test('dv_router', 'tests.test_cost_increase')
    t.test('dv_router', 'tests.test_count_to_inf_poison', extra_args=['--poison-mode'])
    t.test('dv_router', 'tests.test_count_to_inf_poison_v2', extra_args=['--poison-mode'])
    t.test('dv_router', 'tests.test_count_to_inf_poison_v3', extra_args=['--poison-mode'])
    t.finish()
